...
setprop ro.battery,hw.run.mode parallel,dispersion
...
setprop ro.connect.action slippery,high-speed
...
setprop ro.sys.compute stability,naturally
...
echo "######################################################################"
echo "###################### DreamNarae Pure 1.0 ###########################"
echo "#################################Best of DreamNarae Tweak#############"
echo "## Made by Sopiane(Dong Gil, Seo)"
echo "## and Rie (Eun Hee, Lee)"
echo "## and Iren (Jung Yeon, Lee)"
echo "## and Ayana (Eun Jung, Lee)"
echo "## With four people going to make the best Android Tweak!"
echo "## Supported by Colorful Harmony Team- Angeloid Team"
echo "## Thanks to Developer, and User."
echo "## This Version is Final Version We made."
echo "## Enjoy Your Device With DreamNarae!"
echo "######################################################################"
